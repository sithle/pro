...
<script type="text/javascript" src="../js/real-timeReport1.js"></script>
...
<body onload="init()">
	...
	<div id="tb" style="padding:3px">
		<span>当前系统时间：</span> 
		<input type="text" id="currentTime" class="easyui-text" style="width: 120px" /> 
		<span>&nbsp;&nbsp;&nbsp;&nbsp;刷新间隔（分钟）：</span>
		<input type="text" id="timeInterval" class="easyui-text" style="width: 120px" value="<%=stream1_minute%>" /> &nbsp;&nbsp;&nbsp;&nbsp;
		<a id="update" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="update()">更改</a>
		<a id="save" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="save()">保存</a>
		<span>&nbsp;&nbsp;&nbsp;&nbsp;超重标准(吨)：</span>
		<input id="weightStandard" type="text" class="easyui-text" style="width: 30px" value="<%=weight_standard %>" />
	</div>
	<div id="menu" class="easyui-menu" style="display: none;">  
	      <!--放置一个隐藏的菜单Div-->  
	      <div id="btn_More" data-options="iconCls:'icon-remove'" style="width: 150px;" align="center" onclick="playback()">全景视频回放</div>        
	</div> 
