...
<script type="text/javascript" src="../js/WeekReport.js"></script>
...
<body onload="init()">
	...
	<table id="dg" class="easyui-datagrid" style="width:750px;height:435px"
		url="<%=GetCarsJSONServlet %>" title="情况汇总" iconCls="icon-search" toolbar="#tb"
		rownumbers="true" pagination="false" singleSelect="true" fitColumns="false" showFooter="false" >
		<thead>
			<tr>
				<th field="address" width="130" align="center">地点</th>
				<th field="date" width="130" align="center">时间</th>
				<th field="num" width="130" align="center">超重总数</th>

				<th field="over55" width="100" align="center">大于55吨</th>
				<th field="over75" width="100" align="center">大于75吨</th>
			</tr>
		</thead>
	</table>
