...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String GetCarsJSONServlet = basePath + "servlet/GetResultJSON";
	...
	<table id="dg" class="easyui-datagrid" style="width:950px;height:435px"
		...
		<thead>
			<tr>
				...
				<th field="start_time" width="130" align="center">起始时间</th>
				<th field="end_time" width="130" align="center">结束时间</th>
