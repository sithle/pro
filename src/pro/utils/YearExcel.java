...
public class YearExcel {
	...
	public static void getExcel(String sheetName, String excelName,
			List<Map<String, Object>> list, String yearString)
	{
	    ...
	    //System.out.println(bridgename);
		 HSSFWorkbook workbook = new HSSFWorkbook();
			...
			String a="中心"+bridgename+"超限超载车过桥年记录表";
			String b=yearString+"年";
			String[] subStr ={a,b};
			...
			for (int i = 0; i < list.size(); i++) {
				...
				cell0_.setCellValue((String)map_.get("place"));
				HSSFCell cell1_=row.createCell(1);
				cell1_.setCellValue((String)map_.get("time"));
				cell1_.setCellStyle(style5_);
				HSSFCell cell2_=row.createCell(2);
				cell2_.setCellValue((Integer)map_.get("overnumber"));
				cell2_.setCellStyle(style5_);
				HSSFCell cell3_=row.createCell(3);
				cell3_.setCellValue(map_.get("over55number").toString());
				cell3_.setCellStyle(style5_);
				HSSFCell cell4_=row.createCell(4);
				cell4_.setCellValue(map_.get("over75number").toString());
